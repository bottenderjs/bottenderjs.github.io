...
|  Param  |    Type    |                                                                                     Description                                                                                     |
| :-----: | :--------: | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
| handler | `function` | This is a callback function receiving [context](./APIReference-Context) as first parameter and **error as second parameter**. <br> `function handler(context, error) { /* ... */ }` |
